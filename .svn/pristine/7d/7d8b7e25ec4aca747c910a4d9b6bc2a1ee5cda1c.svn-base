...
<body>
<<table id="smstemplate" style="width: 100%" ></table>
</body>
<script type="text/javascript">
//短信模板分页 
$("#smstemplate").datagrid({
	url:"market-sms/smstemplate",
	method:"post",
	toolbar:"#toolbar",
     ...
     onSelect:function(rowIndex, rowData){
    	 $.messager.confirm('警告','确定选择该模板吗？',function(r){
    		    if (r){
    		    	...
    		    	window.location.href="market-sms/company/emailRecord/form?orderId="+rowData.orderId;
