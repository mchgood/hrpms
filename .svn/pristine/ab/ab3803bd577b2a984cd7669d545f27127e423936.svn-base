...
<script type="text/javascript">top.$.jBox.closeTip();</script>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="userId" name="userId" class="input-xlarge required" type="text" value="" maxlength="512" style="height: 30px">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">接收人电话：</label>
			<div class="controls">
				<input id="telephone" name="telephone" class="input-xlarge required" type="text" value="" maxlength="512" style="height: 30px">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="templateId" value="" htmlescape="false" maxlength="512" class="input-xlarge required" style="height: 30px">
