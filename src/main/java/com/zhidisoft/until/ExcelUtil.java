...
public class ExcelUtil {
	...
	public static Object getCellValue(Cell cell) {
		...
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy年MM月dd日"); // 日期格式化
		...
		case Cell.CELL_TYPE_NUMERIC:
			...
			} else if ("m/d/yy".equals(cell.getCellStyle().getDataFormatString())) {//m/d/yy
	...
	public static XSSFWorkbook createExcelFile(Class clazz, List objs, Map<Integer, List<ExcelBean>> map,
			...
			ClassNotFoundException, IntrospectionException, ParseException, InstantiationException {
		// 创建新的Excel工作簿
	 ...
	 * 创建内容
	 * @param sheet  工作表
	 * @param map    表头所在的Map集合
	 * @param objs   要导出的所有数据集合
	 * @param clazz  要导出的数据的实体类class
	 * 
	...
	public static void createTableRows(XSSFSheet sheet, Map<Integer, List<ExcelBean>> map, List objs, Class clazz)
			...
			ClassNotFoundException, ParseException, InstantiationException {
		int rowindex = 1;
		int maxKey = 0;
